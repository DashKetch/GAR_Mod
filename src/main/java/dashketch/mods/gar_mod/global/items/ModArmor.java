...
public class ModArmor {
    ...
    public static final DeferredItem<GarArmorItem> CADET_HELMET = ITEMS.registerItem("cadet_helmet",
    ...
    public static final DeferredItem<GarArmorItem> CADET_CHESTPLATE = ITEMS.registerItem("cadet_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> CADET_LEGGINGS = ITEMS.registerItem("cadet_leggings",
    ...
    public static final DeferredItem<GarArmorItem> CADET_BOOTS = ITEMS.registerItem("cadet_boots",
    ...
    public static final DeferredItem<GarArmorItem> TROOPER_HELMET = ITEMS.registerItem("trooper_helmet",
    ...
    public static final DeferredItem<GarArmorItem> TROOPER_CHESTPLATE = ITEMS.registerItem("trooper_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> TROOPER_LEGGINGS = ITEMS.registerItem("trooper_leggings",
    ...
    public static final DeferredItem<GarArmorItem> TROOPER_BOOTS = ITEMS.registerItem("trooper_boots",
    ...
    public static final DeferredItem<GarArmorItem> SERGEANT_HELMET = ITEMS.registerItem("sergeant_helmet",
    ...
    public static final DeferredItem<GarArmorItem> SERGEANT_CHESTPLATE = ITEMS.registerItem("sergeant_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> SERGEANT_LEGGINGS = ITEMS.registerItem("sergeant_leggings",
    ...
    public static final DeferredItem<GarArmorItem> SERGEANT_BOOTS = ITEMS.registerItem("sergeant_boots",
    ...
    public static final DeferredItem<GarArmorItem> OFFICER_HELMET = ITEMS.registerItem("officer_helmet",
    ...
    public static final DeferredItem<GarArmorItem> OFFICER_CHESTPLATE = ITEMS.registerItem("officer_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> OFFICER_LEGGINGS = ITEMS.registerItem("officer_leggings",
    ...
    public static final DeferredItem<GarArmorItem> OFFICER_BOOTS = ITEMS.registerItem("officer_boots",
    ...
    public static final DeferredItem<GarArmorItem> LANCE_HELMET = ITEMS.registerItem("lance_helmet",
    ...
    public static final DeferredItem<GarArmorItem> LANCE_CHESTPLATE = ITEMS.registerItem("lance_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> LANCE_LEGGINGS = ITEMS.registerItem("lance_leggings",
    ...
    public static final DeferredItem<GarArmorItem> LANCE_BOOTS = ITEMS.registerItem("lance_boots",
    ...
    public static final DeferredItem<GarArmorItem> WO_HELMET = ITEMS.registerItem("wo_helmet",
    ...
    public static final DeferredItem<GarArmorItem> WO_CHESTPLATE = ITEMS.registerItem("wo_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> WO_LEGGINGS = ITEMS.registerItem("wo_leggings",
    ...
    public static final DeferredItem<GarArmorItem> WO_BOOTS = ITEMS.registerItem("wo_boots",
    ...
    public static final DeferredItem<GarArmorItem> UWO_HELMET = ITEMS.registerItem("uwo_helmet",
    ...
    public static final DeferredItem<GarArmorItem> UWO_CHESTPLATE = ITEMS.registerItem("uwo_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> UWO_LEGGINGS = ITEMS.registerItem("uwo_leggings",
    ...
    public static final DeferredItem<GarArmorItem> UWO_BOOTS = ITEMS.registerItem("uwo_boots",
    ...
    public static final DeferredItem<GarArmorItem> CWO_HELMET = ITEMS.registerItem("cwo_helmet",
    ...
    public static final DeferredItem<GarArmorItem> CWO_CHESTPLATE = ITEMS.registerItem("cwo_chestplate",
    ...
    public static final DeferredItem<GarArmorItem> CWO_LEGGINGS = ITEMS.registerItem("cwo_leggings",
