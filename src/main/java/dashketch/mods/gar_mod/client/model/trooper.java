...
public class trooper<T extends LivingEntity> extends HumanoidModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("gar_mod", "trooper"), "main");

	public trooper(ModelPart root) {
		super(root);
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		// Standard HumanoidModel bones (invisible containers)
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		partdefinition.addOrReplaceChild("hat", CubeListBuilder.create(), PartPose.ZERO); // Required dummy
		...
		// --- HEAD ---
		head.addOrReplaceChild("head_base", CubeListBuilder.create()
				...
				.texOffs(6, 59).addBox(1.75F, -2.25F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		rightArm.addOrReplaceChild("right_arm_base", CubeListBuilder.create()
				...
				.texOffs(48, 52).addBox(-3.0F, 10.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		rightArm.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(40, 0).addBox(-4.0F, 0.0F, -2.0F, 12.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 2.0F, 2.0F, 1.5708F, 0.0F, 1.5708F));
		...
		leftArm.addOrReplaceChild("left_arm_base", CubeListBuilder.create()
				...
				.texOffs(16, 56).addBox(-1.0F, 10.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		// --- RIGHT LEG ---
		rightLeg.addOrReplaceChild("right_leg_base", CubeListBuilder.create().texOffs(32, 56).addBox(-2.1F, 12.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		leftLeg.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(48, 56).addBox(-1.0F, 3.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1F, 9.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));
