...
public class cadet<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		// FIX 1: We start with a completely empty mesh. No default Steve boxes!
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();

		// FIX 2: We create the bones required for animation, but leave them completely empty.
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.ZERO);
		partdefinition.addOrReplaceChild("hat", CubeListBuilder.create(), PartPose.ZERO); // Required dummy bone
		...
		// FIX 3: Restoring ALL of your original Blockbench shapes and attaching them to the invisible bones.
		...
		// Original 128x128 texture resolution preserved
