...
public class lance<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // --- GOGGLES (child of head) ---
        PartDefinition goggles = head.addOrReplaceChild("goggles", CubeListBuilder.create()
                        .texOffs(48, 16).addBox(-4.5F, -0.375F, -7.75F, 9.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
                        .texOffs(23, 0).addBox(-3.5F, 0.375F, -8.5F, 7.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -5.625F, 0.25F, -0.3927F, 0.0F, 0.0F));
        goggles.addOrReplaceChild("cube_r4", CubeListBuilder.create()
                        .texOffs(28, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-3.5F, -0.125F, -8.0F, 0.0F, 0.0F, -1.5708F));
        goggles.addOrReplaceChild("cube_r5", CubeListBuilder.create()
                        .texOffs(28, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(3.5F, -0.125F, -8.0F, 0.0F, 0.0F, -1.5708F));
        goggles.addOrReplaceChild("cube_r6", CubeListBuilder.create()
                        .texOffs(23, 0).addBox(-3.5F, 0.0F, -0.5F, 7.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -0.125F, -8.0F, 0.0F, 0.0F, -3.1416F));
        goggles.addOrReplaceChild("cube_r7", CubeListBuilder.create()
                        .texOffs(23, 0).addBox(-3.5F, 0.0F, -0.5F, 7.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -0.125F, -8.0F, -1.5708F, 0.0F, 0.0F));
