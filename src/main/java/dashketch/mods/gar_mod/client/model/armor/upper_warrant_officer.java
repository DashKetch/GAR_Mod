...
public class upper_warrant_officer<T extends LivingEntity> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("gar_mod", "upper_warrant_officer"), "main");

    public upper_warrant_officer(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        rightLeg.addOrReplaceChild("cube_r15", CubeListBuilder.create()
        ...
        rightLeg.addOrReplaceChild("cube_r16", CubeListBuilder.create()
        ...
        leftLeg.addOrReplaceChild("cube_r18", CubeListBuilder.create()
        ...
        leftLeg.addOrReplaceChild("cube_r19", CubeListBuilder.create()
