...
public class warrant_officer<T extends LivingEntity> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("gar_mod", "warrant_officer"), "main");

    public warrant_officer(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("helmet_top", CubeListBuilder.create()
                        ...
                        .texOffs(-3, 4).addBox(-4.05F, -8.05F, -4.0F, 0.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
                        .texOffs(0, 14).addBox(-4.05F, -8.05F, 0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(3, 11).addBox(4.05F, -8.05F, 0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(2, 0).addBox(4.0F, -9.0F, -3.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(2, 0).addBox(3.5F, -9.0F, -3.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(2, 3).addBox(3.0F, -9.0F, -3.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                        .texOffs(2, 3).addBox(3.0F, -9.0F, -1.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.ZERO);
        head.addOrReplaceChild("cube_r1", CubeListBuilder.create()
                        .texOffs(2, 0).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(3.5F, -8.5F, -2.0F, 0.0F, 0.0F, -1.5708F));
        head.addOrReplaceChild("cube_r2", CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-4.0F, -1.55F, 2.0F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(-3, 4).addBox(-4.05F, -1.55F, -3.0F, 0.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -6.5F, -2.0F, 0.0F, 3.1416F, 0.0F));
        head.addOrReplaceChild("cube_r3", CubeListBuilder.create()
                        .texOffs(2, 33).addBox(0.0F, -4.0F, -1.5F, 0.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -6.55F, -3.0F, 0.0F, 1.5708F, -1.5708F));
        head.addOrReplaceChild("cube_r4", CubeListBuilder.create()
                        .texOffs(2, 33).addBox(0.25F, -7.05F, -0.5F, 0.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(3.05F, -8.3F, -3.5F, 3.1416F, 0.0F, 1.5708F));
        head.addOrReplaceChild("cube_r5", CubeListBuilder.create()
                        .texOffs(0, 0).addBox(0.0F, -1.5F, -1.0F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-4.0F, -6.55F, -5.0F, 0.0F, 3.1416F, 0.0F));
        ...
        head.addOrReplaceChild("cube_r8", CubeListBuilder.create()
                        .texOffs(-8, 24).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -4.0F, 4.0F, -1.5708F, 0.0F, 0.0F));

        // --- BODY ---
        body.addOrReplaceChild("cube_r9", CubeListBuilder.create()
                        .texOffs(8, 16).addBox(-9.0F, -1.99F, -1.0F, 12.0F, 0.0F, 8.0F, new CubeDeformation(0.0F))
        ...
        body.addOrReplaceChild("cube_r10", CubeListBuilder.create()
                        ...
                        .texOffs(8, 24).addBox(-9.0F, -2.01F, -1.0F, 12.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)),
        ...
        rightArm.addOrReplaceChild("cube_r12", CubeListBuilder.create()
        ...
        rightArm.addOrReplaceChild("cube_r13", CubeListBuilder.create()
        ...
        leftArm.addOrReplaceChild("left_arm_base", CubeListBuilder.create()
                        ...
                        .texOffs(-2, 5).addBox(-11.0F, -2.01F, -2.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
                PartPose.ZERO);
        leftArm.addOrReplaceChild("cube_r14", CubeListBuilder.create()
                        .texOffs(4, 9).addBox(-1.0F, 0.01F, -2.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-10.0F, -2.0F, 2.0F, 1.5708F, 0.0F, 0.0F));
        leftArm.addOrReplaceChild("cube_r15", CubeListBuilder.create()
                        .texOffs(0, 9).addBox(-1.0F, -0.01F, -2.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-10.0F, -2.0F, -2.0F, 1.5708F, 0.0F, 0.0F));
