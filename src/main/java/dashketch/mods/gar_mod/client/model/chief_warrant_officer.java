...
public class chief_warrant_officer<T extends LivingEntity> extends HumanoidModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("gar_mod", "chief_warrant_officer"), "main");

	public chief_warrant_officer(ModelPart root) {
		super(root);
	}
